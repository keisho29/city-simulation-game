...
export const PROP_LAYOUT: Record<string, PropLayout> = {
  house: { width: 1.45, height: 2.55, originX: 0.5, originY: 0.94 },
  shop: { width: 1.7, height: 2.2, originX: 0.5, originY: 0.92 },
  workshop: { width: 1.55, height: 2.05, originX: 0.5, originY: 0.92 },
  farm: { width: 2.15, height: 1.65, originX: 0.5, originY: 0.78 },
  market: { width: 1.8, height: 2.05, originX: 0.5, originY: 0.92 },
  well: { width: 1.1, height: 1.45, originX: 0.5, originY: 0.92 },
  warehouse: { width: 1.7, height: 2.1, originX: 0.5, originY: 0.92 },
  clinic: { width: 1.7, height: 2.1, originX: 0.5, originY: 0.92 },
  school: { width: 1.75, height: 2.15, originX: 0.5, originY: 0.92 },
  factory: { width: 1.85, height: 2.2, originX: 0.5, originY: 0.92 },
  station: { width: 1.8, height: 2.1, originX: 0.5, originY: 0.92 },
  port: { width: 1.85, height: 2.0, originX: 0.5, originY: 0.9 },
  airport: { width: 1.9, height: 2.05, originX: 0.5, originY: 0.9 },
  tree: { width: 0.7, height: 1.05, originX: 0.5, originY: 0.96 },
  pine: { width: 0.62, height: 1.15, originX: 0.5, originY: 0.96 },
  bush: { width: 0.55, height: 0.82, originX: 0.5, originY: 0.96 },
  mountain: { width: 1.7, height: 2.0, originX: 0.5, originY: 0.92 },
  bridge: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  flower: { width: 0.45, height: 0.45, originX: 0.5, originY: 0.78 },
  rock: { width: 0.95, height: 0.85, originX: 0.5, originY: 0.9 },
  grass: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  fertile: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  hill: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  forest: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  stone: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  water: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  river: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  road: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
  rail: { width: 2, height: 1, originX: 0.5, originY: 0.5 },
